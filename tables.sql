...
DROP TABLE IF EXISTS VideoPlaylist CASCADE;
...
--Entità 8 commento(che include la sottoclasse donazione)
...
--Entità 9 segnalazioni dei video
...
--Entità 10 segnalazioni dei commenti
